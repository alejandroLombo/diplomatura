export function Nosotros(){
    return(
        ...
        <div class="staff">
            ...
            <div class="personas">
                <div class="persona">
                    <img src="img/nosotros/nosotros1.jpg" alt=""></img>
                ...
                <div class="persona">
                    <img src="img/nosotros/nosotros2.jpg" alt=""></img>
                    <h5 class="nombre">Juan Gomez</h5>
                    <h6 class="puesto">Gerente General</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Harum natus obcaecati quia facilis temporibus modi ducimus voluptatem quo recusandae, quam quas
                ...
                <div class="persona">
                    <img src="img/nosotros/nosotros3.jpg" alt=""></img>
                    <h5 class="nombre">Juan Gomez</h5>
                    <h6 class="puesto">Gerente General</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Harum natus obcaecati quia facilis temporibus modi ducimus voluptatem quo recusandae, quam quas
                ...
                <div class="persona">
                    <img src="img/nosotros/nosotros4.jpg" alt=""></img>
                    <h5 class="nombre">Juan Gomez</h5>
                    <h6 class="puesto">Gerente General</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Harum natus obcaecati quia facilis temporibus modi ducimus voluptatem quo recusandae, quam quas
                ...
                <div class="persona">
                    <img src="img/nosotros/nosotros5.jpg" alt=""></img>
                    <h5 class="nombre">Juan Gomez</h5>
                    <h6 class="puesto">Gerente General</h6>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Harum natus obcaecati quia facilis temporibus modi ducimus voluptatem quo recusandae, quam quas
